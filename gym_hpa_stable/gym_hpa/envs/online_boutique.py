...
from gym_hpa_deepsets.gym_hpa.envs.deployment import get_max_cpu, get_max_mem, get_max_traffic, get_online_boutique_deployment_list
from gym_hpa_deepsets.gym_hpa.envs.util import save_to_csv, get_num_pods, get_cost_reward, \
   ...
   #                 get_max_traffic(),  # Average Number of transmit traffic
    ...
    def calculate_reward(self):
        ...
        if self.goal_reward == COST:
            ...
            if reward < -4 and self.none_counter > 2:
                reward = -self.none_counter
